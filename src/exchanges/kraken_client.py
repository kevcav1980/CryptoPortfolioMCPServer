...
class KrakenClient(BaseExchange):
    ...
    def _init_exchange(self) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to initialize Kraken client: {str(e)}")
            raise Exception(f"Kraken initialization failed: {str(e)}")
    ...
    def get_withdrawal_fee(self, symbol: str) -> float:
        ...
        try:
            ...
            logger.warning(f"Could not get withdrawal fee for {symbol} on Kraken")
            return 0.0
